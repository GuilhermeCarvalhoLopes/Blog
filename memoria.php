...
require_once "inserirmemoria.php";
...
$sql = $con->prepare("SELECT 
    ...
    LEFT JOIN tema t ON t.id=p.tema_id where tema_id = '4' ");
$sql->execute();
...
<div class="container-fluid">
    <div class="row content">
        <div class="col-sm-3 sidenav">
            ...
            <ul class="nav nav-pills nav-stacked">
                <hr>
                <li class=" btn btn-danger" style=" width: 550px; color: red;"><a name="logout" href="index.php" class="text-center" style="color: black;">Logout</a></li>
                <hr>
    ...
    <h4>Deixe seu Comentario:</h4>
        ...
        <form action=\"memoria.php\" method=\"post\">
            ...
            <input type='hidden' value='memoria.php' name='url'>
            <input type='hidden' value='4' name='tema_id'>
