...
$sql = $con->prepare("SELECT 
    ...
    LEFT JOIN tema t ON t.id=p.tema_id where tema_id = '9' ");
$sql->execute();
...
<div class="container-fluid">
    ...
    <form action=\"placavideo.php\" method=\"post\">
            ...
            <input type='hidden' value='placavideo.php' name='url'>
            <input type='hidden' value='9' name='tema_id'>
