...
$sql = $con->prepare("SELECT 
    ...
    LEFT JOIN tema t ON t.id=p.tema_id where tema_id = '8' ");
$sql->execute();
...
<div class="container-fluid">
    ...
    <form action=\"placamae.php\" method=\"post\">
            ...
            <input type='hidden' value='placamae.php' name='url'>
            <input type='hidden' value='8' name='tema_id'>
