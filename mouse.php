...
$sql = $con->prepare("SELECT 
    ...
    LEFT JOIN tema t ON t.id=p.tema_id where tema_id = '6' ");
$sql->execute();
...
<div class="container-fluid">
    ...
    <form action=\"mouse.php\" method=\"post\">
            ...
            <input type='hidden' value='mouse.php' name='url'>
            <input type='hidden' value='6' name='tema_id'>
