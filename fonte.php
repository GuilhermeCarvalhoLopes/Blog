...
$sql = $con->prepare("SELECT 
    ...
    LEFT JOIN tema t ON t.id=p.tema_id where tema_id = '7' ");
$sql->execute();
...
<div class="container-fluid">
    ...
    <form action=\"fonte.php\" method=\"post\">
            ...
            <input type='hidden' value='fonte.php' name='url'>
            <input type='hidden' value='7' name='tema_id'>
