...
$sql = $con->prepare("SELECT 
    ...
    LEFT JOIN tema t ON t.id=p.tema_id where tema_id = '5' ");
$sql->execute();
...
<div class="container-fluid">
    ...
    <form action=\"gabinete.php\" method=\"post\">
            ...
            <input type='hidden' value='gabinete.php' name='url'>
            <input type='hidden' value='5' name='tema_id'>
